...
import ParentComponent from "../parentComponents/studentInfoComponents/ParentComponent";
import StudentComponent from "../parentComponents/studentInfoComponents/StudentComponent";
import TodayAttendanceComponent from "../parentComponents/studentInfoComponents/TodayAttendanceComponent";
...
const ParentPanelStudentInfoPage = () => {
  ...
  return (
    <section className="max-w-400 mx-auto p-8 bg-[#f5f7fa] h-screen overflow-y-auto custom-scrollbar">
      ...
      {active === "staff" && <StudentComponent />}

      {/* parent Directory */}
      {active === "parent" && <ParentComponent />}

      {/* today attendance */}
      {active === "staff" && <TodayAttendanceComponent />}
    </section>
  );
};
