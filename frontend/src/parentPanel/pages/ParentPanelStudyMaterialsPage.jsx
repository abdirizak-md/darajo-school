...
import AllMaterialComponent from "../parentComponents/studyMaterialsComponents/AllMaterialComponent";
import StudyMaterialsComponent from "../parentComponents/studyMaterialsComponents/StudyMaterialsComponent";
  ...
  return (
    <section className="max-w-400 mx-auto p-8 bg-[#f5f7fa] h-screen overflow-y-auto custom-scrollbar">
      ...
      <div className="lg:flex md:flex grid grid-cols-[repeat(auto-fit,minmax(100px,1fr))] gap-4 mb-4">
        {["Materials", "Documents", "Video", "Audio", "Images", "Links"].map(
          (tab, index) => (
            <button
              key={index}
