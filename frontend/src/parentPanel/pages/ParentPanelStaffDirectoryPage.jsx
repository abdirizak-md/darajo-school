...
import AssignmentComponent from "../parentComponents/staffDirectoryComponents/AssignmentComponent";
import PayrollComponent from "../parentComponents/staffDirectoryComponents/PayrollComponent";
import StaffDirectoryComponent from "../parentComponents/staffDirectoryComponents/StaffDirectoryComponent";
import TeacherEnrollmentComponent from "../parentComponents/staffDirectoryComponents/TeacherEnrollmentComponent";

const ParentPanelStaffDirectoryPage = () => {
  ...
  return (
    <section className="max-w-400 mx-auto p-8 bg-[#f5f7fa] h-screen overflow-y-auto custom-scrollbar">
      ...
      {active === "Staff" && <StaffDirectoryComponent />}
      ...
      {/* enroll */}
      {active === "enroll" && <TeacherEnrollmentComponent />}
    </section>
  );
};

export default ParentPanelStaffDirectoryPage;
