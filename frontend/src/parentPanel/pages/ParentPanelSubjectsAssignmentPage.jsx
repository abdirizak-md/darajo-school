...
import AssignedTeachersComponent from "../parentComponents/subjectAssignmentComponents/AssignedTeachersComponent";
import AssignmentComponent from "../parentComponents/subjectAssignmentComponents/AssignmentComponent";
import GradeComponent from "../parentComponents/subjectAssignmentComponents/GradeComponent";
import SubjectComponent from "../parentComponents/subjectAssignmentComponents/SubjectComponent";

const ParentPanelSubjectsAssignmentPage = () => {
  ...
  return (
    <section className="max-w-400 mx-auto p-8 bg-[#f5f7fa] h-screen overflow-y-auto custom-scrollbar">
      ...
      <div className="flex gap-5 mb-8">
        {["subjects", "assignments", "grades", "assigned teachers"].map(
          (tab, index) => (
            <button
              key={index}
      ...
      {/* assigned teachers  */}
      {active === "assignedTeachers" && <AssignedTeachersComponent />}
    </section>
  );
};

export default ParentPanelSubjectsAssignmentPage;
