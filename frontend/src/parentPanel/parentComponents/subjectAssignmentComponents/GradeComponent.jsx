  ...
  return (
    <div className="bg-white p-6 mb-6 shadow rounded-md">
      <div className="flex justify-between items-center mb-4">
        ...
        <button className="lg:px-5 py-2 px-3 cursor-pointer text-white bg-orange-500 rounded-md inline-flex items-center gap-2">
          <FaPlus />
          Import Grades
        </button>
      </div>
        ...
        <table className="min-w-200 w-full border-collapse mt-4">
          <thead>
            <tr>
              <th
                scope="col"
                className="p-4 bg-[#f8f9fa] text-[#333] font-semibold border-b border-[#e1e5e9] text-left"
              >
                Student Name
              </th>
              <th
              ...
              <tr key={grade.id} className="hover:bg-[#f8f9fa]">
                ...
                <td className="p-4 border-b border-[#e1e5e9] text-left flex gap-2">
                  <div className="flex gap-2">
                    <button
                      type="button"
                      className="bg-[#10b981] text-white border border-[#e1e5e9] px-4 py-1.5 rounded-md hover:bg-[#0c9c6c] transition-colors"
                    >
                      View
                    </button>
                    <button
                      type="button"
                      className="bg-gray-50 text-gray-700 border border-gray-200 px-4 py-1.5 rounded-md hover:bg-gray-100 transition-colors"
                    >
                      Edit
                    </button>
                  </div>
