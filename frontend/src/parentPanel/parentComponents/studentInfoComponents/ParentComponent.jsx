            ...
            {student.map((student, index) => (
              <tr key={index} className="hover:bg-[#f8f9fa]">
                ...
                <td className="p-4 border-b border-[#e1e5e9] text-left flex gap-2">
                  <button className="bg-[#fcd116] hover:bg-[#ffda33] text-[#333] border border-[#e1e5e9] px-4 py-2 rounded-md">
                    Edit
                  </button>
                  <button className="bg-[#ce1126] hover:bg-[#dc001a] text-white border border-[#e1e5e9] px-4 py-2 rounded-md">
                    Delete
                  </button>
                </td>
              </tr>
