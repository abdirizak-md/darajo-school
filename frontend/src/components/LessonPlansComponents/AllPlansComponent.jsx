  ...
  return (
    <div className="bg-white p-6 mb-6 shadow rounded-md">
        <div className="flex justify-between items-center mb-4">
            ...
            <button className='lg:px-5 px-3 py-2 cursor-pointer text-white bg-orange-500 rounded-md inline-flex items-center gap-2' onClick={() => setClose(true)}><FaPlus />Create Lesson Plan</button>
        </div>
        ...
        <div className="grid grid-cols-[repeat(auto-fit,minmax(350px,1fr))] gap-6 mt-4">
            ...
            <div key={index} className="bg-white rounded-2xl p-6 shadow-[0_5px_20px_rgba(0,0,0,0.1)] border-l-4 border-l-orange-500">
                <div className="flex justify-between items-start mb-4">
                    <div className="">
                        <h1 className='text-lg font-medium text-orange-500 mb-2'>{lesson.lessonName}</h1>
