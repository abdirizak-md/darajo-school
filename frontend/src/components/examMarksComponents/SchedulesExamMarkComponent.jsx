      ...
      <div className="w-full overflow-x-auto">
        <form action="post">
                ...
                <tr key={index} className="hover:bg-[#f8f9fa]">
                  ...
                  <td className="p-4 border-b border-[#e1e5e9] text-left flex gap-2">
                    <input
                      type="number"
                      name="exam"
                      className="border border-[#e1e5e9] rounded-md p-2.5 w-1/5 "
                    />
                  </td>
                </tr>
              ))}
          ...
          <div className="w-full flex justify-end">
            <button
              type="submit"
              className="bg-orange-500 text-white py-2 px-4 rounded-md hover:bg-orange-600 transition-colors duration-300 mt-4 flex itecms-end"
            >
              Save Marks
            </button>
          </div>
