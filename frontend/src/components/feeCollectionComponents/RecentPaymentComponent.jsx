...
import { useGetPaymentsQuery } from "../../redux/features/paymentApi";
// import { useGetBalanceQuery } from "../../redux/features/balanceApi";

const RecentPaymentComponent = ({ setRecordPayment }) => {
  const { data: feeType } = useGetFeeTypesQuery();
  const { data: feeStucture } = useGetFeeStructuresQuery();
  const { data: paymentData } = useGetPaymentsQuery();
  // const { data: balance } = useGetBalanceQuery();

  // console.log("fee type", paymentData);
