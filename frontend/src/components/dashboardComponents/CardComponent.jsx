import { FaArrowDown, FaArrowUp, FaCalendar, FaChalkboardUser, FaClock, FaEnvelope, FaGraduationCap } from "react-icons/fa6"
  ...
  const schoolData = [
    ...
    { title: 'ACTIVE CLASSES', inNumber: '25', upRise: '+2 this term', upRiseIcon: <FaArrowUp className='text-emerald-500'/>, icon: <FaChalkboardUser className='text-white' size={20}/>, iconBgColor: 'bg-emerald-500', borderColors: 'border-emerald-500', textColors: 'text-emerald-500' },
    { title: 'ATTENDANCE TODAY', inNumber: '96%', upRise: '+5 vs yesterday', upRiseIcon: <FaArrowUp className='text-emerald-500'/>, icon: <FaChalkboardUser className='text-white' size={20}/>, iconBgColor: 'bg-emerald-500', borderColors: 'border-emerald-500', textColors: 'text-emerald-500' },
