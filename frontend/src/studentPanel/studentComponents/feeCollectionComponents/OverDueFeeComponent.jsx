  ...
  return (
    <div className="bg-white p-6 mb-6 shadow rounded-md">
      <div className="flex justify-between items-center mb-4">
        ...
        <button className="px-3 lg:px-5 py-2 cursor-pointer text-white bg-[#ce1126] rounded-md inline-flex items-center gap-2">
          <FaPlus />
          Send Urgent Remainders
        </button>
      </div>
            ...
            {overdueFees.map((overdues, index) => (
              <tr key={index} className="hover:bg-[#f8f9fa]">
                ...
                <td className="p-4 border-b border-[#e1e5e9] text-left flex gap-2">
                  ...
                  <button className="bg-[#ce1126] text-white border border-[#e1e5e9] px-4 py-2 rounded-md">
                    Call Parent
                  </button>
                </td>
              </tr>
