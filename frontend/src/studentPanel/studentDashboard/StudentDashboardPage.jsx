...
import CardComponent from "../studentComponents/dashboardComponents/CardComponent";
import RecentActivityComponent from "../studentComponents/dashboardComponents/RecentActivityComponent";
        ...
        <main className="flex-1 overflow-y-auto bg-[#f5f7fa] custom-scrollbar p-8 transition-all duration-300 ease-in-out">
          ...
          <div className="flex items-center justify-between mb-8">
            <div className="flex flex-col">
              <h1 className="text-3xl text-[#333] font-bold">
