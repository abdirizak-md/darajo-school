...
import { academics, dashboard, feesAccounts, studentManagement } from '../../Data/studentPanelData/studentSideBar';
      ...
      <div className="flex items-center justify-between px-4 py-5 border-b border-white/10">
        {open && (
          <div className="flex items-center gap-3">
            ...
            <span className="text-orange-500 font-bold tracking-wide font-serif"> DARAJO </span>
          </div>
        )}
        ...
        { close && <button onClick={() => setClose(false)} aria-expanded={open} className="p-2 rounded-xl hover:bg-orange-500/15 transition duration-200" >
          <MdClose className={`text-2xl transition-transform duration-300 text-orange-500 ${ open ? 'rotate-0' : 'rotate-180' }`} />
        </button> }
      </div>
