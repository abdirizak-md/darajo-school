...
import AssignmentComponent from "../studentComponents/subjectAssignmentComponents/AssignmentComponent";
import GradeComponent from "../studentComponents/subjectAssignmentComponents/GradeComponent";
import SubjectComponent from "../studentComponents/subjectAssignmentComponents/SubjectComponent";

const StudentPanelSubjectsAssignmentPage = () => {
  ...
  return (
    <section className="max-w-400 mx-auto p-8 bg-[#f5f7fa] h-screen overflow-y-auto custom-scrollbar">
      ...
      <div className="flex gap-5 mb-8">
        ...
        <button
          onClick={() => setActive("assignedTeachers")}
          className={`px-8 py-3 border border-[#e1e5e9]  rounded-md hover:shadow-md active:scale-95 transition-all duration-200 shadow-[0_5px_20px_rgba(0,0,0,0.1)] ${active == "assignedTeachers" ? "bg-orange-500 text-white" : "bg-white"}`}
        >
          Assigned Teachers
        </button>
      </div>
...
export default StudentPanelSubjectsAssignmentPage;
