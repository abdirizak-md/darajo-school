...
import AllClassesComponent from "../studentComponents/sectionClassComponents/AllClassesComponent";
import ScheduleComponent from "../studentComponents/sectionClassComponents/ScheduleComponent";
import SectionsComponent from "../studentComponents/sectionClassComponents/SectionsComponent";

const StudentPanelClassesSectionsPage = () => {
  ...
  return (
    <section className="max-w-400 mx-auto p-8 bg-[#f5f7fa] h-screen overflow-y-auto custom-scrollbar">
      ...
      <div className="flex gap-5 mb-8">
        {["classes", "sections", "scheduls"].map((Tab, index) => (
          <button
            key={index}
...
export default StudentPanelClassesSectionsPage;
