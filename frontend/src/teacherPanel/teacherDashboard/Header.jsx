  ...
  return (
    <header className="hidden md:flex items-center justify-between px-8 py-4 bg-white border-b border-gray-200 shadow-sm">
      ...
      <div className="flex flex-col">
        <h1 className="text-2xl font-bold text-orange-500">Darajo SchoolMS</h1>
      ...
      <form onSubmit={handleSubmit} className="flex-1 max-w-xl mx-8" >
        <div className="flex items-center bg-gray-100 rounded-full px-4 py-2 focus-within:ring-2 focus-within:ring-orange-500 transition">
      ...
      <div className="flex items-center gap-6">
        ...
        <div className="flex items-center gap-3 cursor-pointer select-none">
          <div className="w-9 h-9 flex items-center justify-center rounded-full bg-linear-to-br to-orange-500 from-red-500 text-white text-sm font-semibold shadow-md">
            T
          </div>

          <div className="flex items-center gap-1 text-gray-700">
            {open && <span className="text-sm font-medium">Teacher</span>}
