...
const TeacherPanelSubjectsAssignmentPage = () => {
  ...
  return (
    <section className='max-w-400 mx-auto p-8 bg-[#f5f7fa] h-screen overflow-y-auto custom-scrollbar'>
        ...
        <div className="bg-white rounded-md p-8 shadow-[0_5px_20px_rgba(0,0,0,0.1)] mb-8">
            <h1 className='text-orange-500 lg:text-4xl text-2xl font-bold mb-4'>🏠 Subjects & Assignment</h1>
...
export default TeacherPanelSubjectsAssignmentPage