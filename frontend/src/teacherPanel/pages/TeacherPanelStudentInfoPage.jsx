...
const TeacherPanelStudentInfoPage = () => {
  ...
  return (
    <section className='max-w-400 mx-auto p-8 bg-[#f5f7fa] h-screen overflow-y-auto custom-scrollbar'>
        ...
        <div className="bg-white rounded-md p-8 shadow-[0_5px_20px_rgba(0,0,0,0.1)] mb-8">
            <h1 className='text-orange-500 text-3xl font-bold mb-4'>🏠 Student Management</h1>
        ...
        <div className="flex gap-5 mb-8">
            <button onClick={() => setActive('staff')} className={`px-8 py-3 border border-[#e1e5e9]  hover:shadow-md active:scale-95 transition-all duration-200 rounded-md shadow-[0_5px_20px_rgba(0,0,0,0.1)] ${active == 'staff' ? 'bg-orange-500 text-white' : 'bg-white'}`}>All Students</button>
            <button onClick={() => setActive('parent')} className={`px-8 py-3 border border-[#e1e5e9] hover:shadow-md active:scale-95 transition-all duration-200 rounded-md shadow-[0_5px_20px_rgba(0,0,0,0.1)] ${active == 'parent' ? 'bg-orange-500 text-white' : 'bg-white'}`}>Parents</button></div>
...
export default TeacherPanelStudentInfoPage