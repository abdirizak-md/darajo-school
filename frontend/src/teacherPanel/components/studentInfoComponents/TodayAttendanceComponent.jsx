  ...
  return (
    <div className="bg-white p-6 mb-8 shadow rounded-md">
        <div className="flex justify-between items-center mb-8">
            ...
            <button className='px-5 py-2 text-white bg-orange-500 rounded-md flex items-center gap-2' onClick={() => setmodelAttendance(true)} ><FaCheck />Mark Attendance</button>
        </div>
        <div className="grid grid-cols-[repeat(auto-fit,minmax(300px,1fr))] gap-4 mb-8">
            <div className="flex flex-col bg-[#f8f9fa] rounded-lg border-l-4 border-orange-500 px-6 py-4">
            <h1 className='text-lg'>Class 10A</h1>
            <div className="flex justify-between py-1">
                <span className='text-orange-500'>Present: 25</span>
