            ...
            <table className="min-w-200 w-full border-collapse mt-4">
                ...
                <tbody className='table-row-group border-inherit'>
                    {   fees?.data.map((fee, index) => (
                        ...
                        <td className='p-4 border-b border-[#e1e5e9] text-left'>{fee.student?.fullName}</td>
                        <td className='p-4 border-b border-[#e1e5e9] text-left'>{fee.feeType?.name}</td>
                        <td className='p-4 border-b border-[#e1e5e9] text-[#ce1126] font-bold text-left'>{fee.amount}</td>
                        <td className='p-4 border-b border-[#e1e5e9] text-left'>{fee.dueDate}</td>
                        <td className='p-4 border-b border-[#e1e5e9] text-left'>{fee.daysLeft}</td>
